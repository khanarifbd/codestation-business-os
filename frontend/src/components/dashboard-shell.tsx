...
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  useEffect(()=>{if(clientOnly&&pathname!=="/dashboard/client-portal"&&!pathname.startsWith("/dashboard/profile")){router.replace("/dashboard/client-portal");return;}if(employeeSelfService&&pathname==="/dashboard")router.replace(employeeLanding);},[clientOnly,employeeLanding,employeeSelfService,pathname,router]);
