      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <section className="overflow-hidden rounded-3xl border bg-neutral-950 text-white shadow-sm">
          <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <div className="flex items-start gap-4 sm:gap-5">
              <div className="flex size-16 shrink-0 items-center justify-center rounded-2xl border border-white/15 bg-white/10 text-xl font-semibold sm:size-20 sm:text-2xl">
        ...
        <section className="rounded-3xl border bg-white p-5 shadow-sm sm:p-6">
          ...
          {profile.has_password ? (
            ...
            <div className="mt-6 rounded-2xl border border-blue-200 bg-blue-50 p-5 text-sm leading-6 text-blue-900"><p className="font-semibold">This account currently uses Google Sign-In.</p><p className="mt-1 text-blue-800">There is no password attached to this identity, so Business OS will not create one from a normal authenticated session. This avoids letting a stolen session establish a permanent password. Continue signing in with Google; a future password-creation flow should require secure re-authentication first.</p></div>
          )}
        </section>
      </div>
    </main>
