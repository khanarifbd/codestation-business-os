...
class PayrollWithholdingPayment(TenantOwnedMixin, Base):
    __tablename__ = "payroll_withholding_payments"
    __table_args__ = (
        Index("ix_payroll_withholding_payments_org_date", "organization_id", "payment_date"),
    )
