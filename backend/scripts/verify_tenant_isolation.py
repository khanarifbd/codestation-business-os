...
def main() -> None:
    with SessionLocal() as db:
        ...
        if client is None or order is None or project is None or invoice is None:
            raise AssertionError("tenant isolation fixtures require client, order, project and invoice records")
    ...
    print("tenant isolation verification passed: client, order, project and invoice cross-tenant access denied")
