...
function Section({ title, action, children, className = "" }: { title: string; action?: React.ReactNode; children: React.ReactNode; className?: string }) { return <ClientWorkspaceSection title={title} action={action} className={className}>{children}</ClientWorkspaceSection>; }
