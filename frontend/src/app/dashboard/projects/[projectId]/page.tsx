...
export default function ProjectWorkspacePage() {
  ...
  return <main className="min-h-screen bg-neutral-100 p-5 sm:p-7 lg:p-9"><div className="mx-auto max-w-[1500px]">
    ...
    <section className="mt-5">
      ...
      {tab === "documents" ? <Documents projectId={projectId} rows={workspace.documents} onAdd={() => setModal("document")} onChanged={() => void refreshWorkspace()} /> : null}
...
function Documents({ projectId, rows, onAdd, onChanged }: { projectId: string; rows: DocumentRow[]; onAdd: () => void; onChanged: () => void }) {
