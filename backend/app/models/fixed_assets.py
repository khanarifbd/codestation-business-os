...
class FixedAsset(TenantOwnedMixin, Base):
    ...
    opening_accumulated_depreciation: Mapped[Decimal] = mapped_column(Numeric(18, 2), default=Decimal("0"), nullable=False)
    record_mode: Mapped[str] = mapped_column(String(16), default="purchase", nullable=False)
