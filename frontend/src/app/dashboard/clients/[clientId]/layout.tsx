...
export default async function ClientDetailLayout({
  ...
  return <div className="min-h-screen bg-neutral-100">
    {children}
    <div className="px-4 pb-9 sm:px-7 lg:px-9"><div className="mx-auto max-w-[1500px] space-y-5"><ClientServicesSection clientId={clientId} /><ClientExternalProfilesSection clientId={clientId} /><ClientAccessSection clientId={clientId} /></div></div>
  </div>;
}
