...
def _milestone_read(db, milestone: OrderBillingMilestone) -> BillingMilestoneRead:
    ...
    return BillingMilestoneRead(
        ...
        source_quotation_payment_milestone_id=milestone.source_quotation_payment_milestone_id,
        source_quotation_milestone_id=milestone.source_quotation_milestone_id,
        source_payment_type=milestone.source_payment_type,
        source_percentage=milestone.source_percentage,
...
def create_billing_milestone(db, order: Order, payload: BillingMilestoneCreate, user_id: str, request: Request) -> BillingMilestoneRead:
    ...
    milestone = OrderBillingMilestone(
        ...
        due_condition=(payload.due_condition or "").strip() or None,
        currency=order.currency,
        amount=amount,
