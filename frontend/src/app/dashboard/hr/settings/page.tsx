...
export default function HRSettingsPage() {
  ...
  return <main className="min-h-screen bg-neutral-100 p-4 sm:p-8 lg:p-10"><div className="mx-auto max-w-[1400px]">
    ...
    <section className="mt-6 flex flex-col gap-3 rounded-2xl border border-neutral-200 bg-white p-5 sm:flex-row sm:items-center sm:justify-between"><div><h2 className="font-semibold">Office GPS & weekly attendance modes</h2><p className="mt-1 text-sm text-neutral-500">Set office geofences, assign remote/field days and approve attendance exceptions.</p></div><Link href="/dashboard/hr/settings/attendance" className="shrink-0 rounded-xl bg-neutral-950 px-4 py-2.5 text-sm font-semibold text-white">Configure attendance</Link></section>
